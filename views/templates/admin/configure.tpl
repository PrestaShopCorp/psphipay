...
<div class="panel">
	<h3>PrestaShop Payment (by Hipay)</h3>
	<img src="{$module_dir|escape:'html':'UTF-8'}/img/hipay.png" id="ppayment-logo" class="pull-right" />
	<p>
		<strong>{l s='The fast, simple multimedia payment solution for everyone in France and Europe!' mod='psphipay'}</strong><br />
		...
		<br />
		{l s='Do not hesitate to contact us. The fees can decrease by 50%.' mod='psphipay'}<br />
	</p>
	<br />
	<p>	
		{l s='Hipay boosts your sales Europe-wide thanks to' mod='psphipay'}:
		<ul>
