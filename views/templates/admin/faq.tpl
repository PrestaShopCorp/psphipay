...
<dl id="faq_q_a">
    ...
    <dd id="faq1" class="panel-collapse collapse">
        <p>
            ...
            {l s='To see which payment methods are available per country, please [1]click here[/1].' tags=[$localized_rates_pdf_link] mod='psphipay'}
        </p>
    </dd>
    ...
    <dd id="faq2" class="panel-collapse collapse">
        <p>
            ...
            {l s='To see which payment solutions are available in each country, please [1]click here[/1].' tags=[$localized_rates_pdf_link] mod='psphipay'}
    ...
    <dd id="faq5" class="panel-collapse collapse">
        <p>
            {l s='[1]Click here[/1] to view the full rates.' tags=[$localized_rates_pdf_link] mod='psphipay'}<br />
    ...
    <dd id="faq8" class="panel-collapse collapse">
        <p>
            ...
            {l s='In keeping with our General Conditions of Use, you must inform HiPay of any changes to your personal data, and submit suitable items of written proof.' mod='psphipay'}
        </p>
    </dd>
