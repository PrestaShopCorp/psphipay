...
class PSPHipayForm extends PSPHipayFormInputs {
	...
	public function getCustomersServiceFormValues()
	{
		...
		return array(
			...
			'customers_service_contact_info' =>  '<h4 class="form-control-static"><i class="icon icon-info-circle"></i> '.$this->module->l('Please remind them your account details', 'PSPHipayForm').'</h4>',
